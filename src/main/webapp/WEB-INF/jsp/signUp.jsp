...
<%--        <img class="mb-4" src="Icons/icons8-hr-100.png" alt="" width="72" height="72">--%>
        ...
        <form:input type="email" id="inputEmail" class="form-control" placeholder="Email address"  path="email" required=""/>
        <label for="username" class="sr-only">Password</label>
        <form:input type="text" id="username" class="form-control"  placeholder="Username" path="username" required=""/>
        ...
        <form:input type="password" id="inputPassword" class="form-control"  placeholder="Password" path="password" required=""/>
